...
* Stable **[Citation Keys](Citation-Keys.html)**, without key clashes! Generates citation keys that take into account other existing keys in your library
...
* Set your own, fixed **[Citation Keys](Citation-Keys.html)**, generate citation keys from JabRef patterns, drag and drop LaTeX citations, add other custom BibLaTeX fields
...
* Automatic **[journal abbreviation](Citation-Keys.html)**
